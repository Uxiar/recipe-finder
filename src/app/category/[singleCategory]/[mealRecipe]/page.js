...
const SingleMeal = () => {
  ...
  return (
    <main className=" relative mx-auto p-4 md:p-8 bg-black rounded-lg shadow-lg">
          ...
          <article key={item.idMeal} className="space-y-6">
            <header className="mb-6">
              <h1 className="text-3xl font-bold text-white">
                {item.strMeal}{" "}
                <span className="text-orange-500">({item.strCategory})</span>
              </h1>
              <p className="text-white italic">{item.strArea} cuisine</p>
            </header>
